...
public class HelloExtensionService extends ExtensionService   {
 ...
 public static final String EXTENSION_KEY =  "com.example.hellosmartwatch.key";
 public static final String INTENT_ACTION_ADD = "com.example.hellosmartwatch.action.add";
 public static final String INTENT_ACTION_CLEAR = "com.example.hellosmartwatch.action.clear";
 ...
 protected boolean keepRunningWhenConnected() {
	 //true if we want to keep the ExtensionService running as long as Smart watch is connected to phone
  return false;
 }
 ...
 protected void onViewEvent(Intent intent) {
	 ...
	 System.out.println("fkhkjf");
  //String action = intent.getStringExtra(Notification.	.EXTRA_ACTION);
...
//  
//  try {
//   Cursor cursor = getContentResolver().query(Notification.Event.URI,null, BaseColumns._ID + " = " + eventId,null, null);
...
//    Toast.makeText(this,"Notification: Name: " + name + " Message: " + message,Toast.LENGTH_SHORT).show();
//    Log.i(TAG, "Name: " + name);
