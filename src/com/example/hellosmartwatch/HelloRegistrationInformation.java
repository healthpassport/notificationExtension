...
public class HelloRegistrationInformation extends RegistrationInformation{
 ...
 public ContentValues[] getSourceRegistrationConfigurations() {
   ...
   ContentValues sourceValues = null;
         ...
         String iconSource1 = ExtensionUtils.getUriString(mContext,R.drawable.ic_launcher);
         String iconSource2 = ExtensionUtils.getUriString(mContext,R.drawable.ic_launcher);
         String iconBw = ExtensionUtils.getUriString(mContext,R.drawable.ic_launcher);
